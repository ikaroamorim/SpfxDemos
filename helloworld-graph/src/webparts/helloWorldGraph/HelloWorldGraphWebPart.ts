...
import styles from './HelloWorldGraphWebPart.module.scss';
import * as strings from 'HelloWorldGraphWebPartStrings';

import { MSGraphClient } from '@microsoft/sp-http';
import * as MicrosoftGraph from '@microsoft/microsoft-graph-types';

export interface IHelloWorldGraphWebPartProps {
  description: string;
}

export default class HelloWorldGraphWebPart extends BaseClientSideWebPart<IHelloWorldGraphWebPartProps> {
  ...
  public render(): void {
    ...
    .then((client: MSGraphClient): void => {
      ...
      .get((error, messages: any, rawResponse?: any) => {
        ...
        <div class="${ styles.helloWorldGraph}">
